...
public class AdminMain implements Initializable {
	...
	@FXML public void movieEditAction(ActionEvent event) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/admin/MovieEdit.fxml"));
			Parent root = loader.load();
			MovieEdit umc = loader.getController();
	...
	@FXML public void salesBtAction(ActionEvent event) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/admin/SalesMain.fxml"));
			Parent root = loader.load();
			SalesMain umc = loader.getController();
			umc.userId.setText(this.userId.getText());
			Scene scene = new Scene(root);
			Stage stage = new Stage();
			stage.setTitle("매출");
	...
	@FXML public void userListAction(ActionEvent event) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/admin/UserList.fxml"));
			Parent root = loader.load();
			UserList umc = loader.getController();
			umc.userId.setText(this.userId.getText());
			Scene scene = new Scene(root);
			Stage stage = new Stage();
			stage.setTitle("회원목록");
